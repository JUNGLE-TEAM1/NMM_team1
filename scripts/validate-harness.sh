...
if ! rg -q "완료 \\+ PR 준비 상태입니다.*선택지별 절차/장점/주의사항.*1 PR 진행\\(push, PR 생성, CI 확인, merge, finalize, issue close 확인\\).*2 추가 보강.*3 다음 Phase.*4 보류.*5 외부 실행 승인" scripts/status-workflow.sh; then
