...
AskLake는 여러 데이터 소스를 연결해 검증된 데이터셋으로 게시하고, 권한 안에서 SQL과 자연어 질문으로 활용하며, 답변과 분석 결과의 근거를 리니지·품질·정책·감사 기록으로 확인하게 하는 self-hosted Trusted Data & AI Platform을 목표로 한다.
