...
from .common import csv_dialect, detect_format, ensure_dir, flatten_json, pii_hint, stable_json_hash, value_type, write_json
...
def build_l2(
    ...
    write_json(layer_dir / "schema_fingerprint.json", {"source_id": source_id, "schema_fingerprint": fingerprint, "basis": schema_basis})
    return {"profile": profile, "schema_fingerprint": fingerprint}
