...
- Verified: focused unittest, JSONL 100,000행 parse/6필드 검증, manifest/summary JSON validation, `Week2LocalRunner` smoke -> `fallback_succeeded`, input `row_count=100000`, output `output_row_count=28190`, strict harness validation.
