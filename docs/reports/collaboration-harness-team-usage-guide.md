...
11. [확인 게이트란 무엇인가](#11-확인-게이트란-무엇인가)
12. [PR과 merge 흐름](#12-pr과-merge-흐름)
13. [AI가 자동으로 할 수 있는 일과 사람 확인이 필요한 일](#13-ai가-자동으로-할-수-있는-일과-사람-확인이-필요한-일)
14. [팀원이 하면 안 되는 것](#14-팀원이-하면-안-되는-것)
15. [좋은 요청 예시와 애매한 요청 예시](#15-좋은-요청-예시와-애매한-요청-예시)
16. [자주 묻는 질문](#16-자주-묻는-질문)
17. [팀원용 체크리스트](#17-팀원용-체크리스트)
...
## 13. AI가 자동으로 할 수 있는 일과 사람 확인이 필요한 일
...
### 14.2 PR 생성과 merge를 같은 말로 뭉개지 않기
...
### 14.3 문서 변경이 필요한데 코드만 바꾸라고 하지 않기
...
### 14.5 conflict나 CI 실패를 무시하고 merge하지 않기
