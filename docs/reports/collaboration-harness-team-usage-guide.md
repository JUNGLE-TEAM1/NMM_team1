...
9. [하네스를 사용할 때 사람의 책임과 AI의 책임](#9-하네스를-사용할-때-사람의-책임과-ai의-책임)
10. [확인 게이트란 무엇인가](#10-확인-게이트란-무엇인가)
11. [PR과 merge 흐름](#11-pr과-merge-흐름)
12. [AI가 자동으로 할 수 있는 일과 사람 확인이 필요한 일](#12-ai가-자동으로-할-수-있는-일과-사람-확인이-필요한-일)
13. [팀원이 하면 안 되는 것](#13-팀원이-하면-안-되는-것)
14. [좋은 요청 예시와 애매한 요청 예시](#14-좋은-요청-예시와-애매한-요청-예시)
15. [자주 묻는 질문](#15-자주-묻는-질문)
16. [팀원용 체크리스트](#16-팀원용-체크리스트)
...
AI는 책임 있는 결정을 사람이 하기 쉽게 증거와 선택지를 정리한다.
```
...
좋은 하네스 사용자는 모든 명령어를 외우는 사람이 아닙니다. 좋은 사용자는 중요한 선택 앞에서 무엇을 확인해야 하는지 아는 사람입니다.
...
## 12. AI가 자동으로 할 수 있는 일과 사람 확인이 필요한 일
...
### 13.2 PR 생성과 merge를 같은 말로 뭉개지 않기
...
### 13.3 문서 변경이 필요한데 코드만 바꾸라고 하지 않기
...
### 13.5 conflict나 CI 실패를 무시하고 merge하지 않기
