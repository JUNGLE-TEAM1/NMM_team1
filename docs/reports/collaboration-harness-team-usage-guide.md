...
8. [전체 작업 흐름](#8-전체-작업-흐름)
9. [팀원이 기억할 최소 규칙](#9-팀원이-기억할-최소-규칙)
10. [AI에게 요청하는 방법](#10-ai에게-요청하는-방법)
11. [Phase 작업 흐름](#11-phase-작업-흐름)
12. [작업 중 방향을 바꾸고 싶을 때](#12-작업-중-방향을-바꾸고-싶을-때)
13. [확인 게이트란 무엇인가](#13-확인-게이트란-무엇인가)
14. [PR과 merge 흐름](#14-pr과-merge-흐름)
15. [AI가 자동으로 할 수 있는 일과 사람 확인이 필요한 일](#15-ai가-자동으로-할-수-있는-일과-사람-확인이-필요한-일)
16. [팀원이 하면 안 되는 것](#16-팀원이-하면-안-되는-것)
17. [좋은 요청 예시와 애매한 요청 예시](#17-좋은-요청-예시와-애매한-요청-예시)
18. [자주 묻는 질문](#18-자주-묻는-질문)
19. [팀원용 체크리스트](#19-팀원용-체크리스트)
...
## 15. AI가 자동으로 할 수 있는 일과 사람 확인이 필요한 일
...
### 16.2 PR 생성과 merge를 같은 말로 뭉개지 않기
...
### 16.3 문서 변경이 필요한데 코드만 바꾸라고 하지 않기
...
### 16.5 conflict나 CI 실패를 무시하고 merge하지 않기
