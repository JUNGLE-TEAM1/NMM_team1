...
6. [전체 작업 흐름](#6-전체-작업-흐름)
7. [팀원이 기억할 최소 규칙](#7-팀원이-기억할-최소-규칙)
8. [AI에게 요청하는 방법](#8-ai에게-요청하는-방법)
9. [Phase 작업 흐름](#9-phase-작업-흐름)
10. [작업 중 방향을 바꾸고 싶을 때](#10-작업-중-방향을-바꾸고-싶을-때)
11. [하네스를 사용할 때 사람의 책임과 AI의 책임](#11-하네스를-사용할-때-사람의-책임과-ai의-책임)
12. [하네스를 쓰는 팀원의 5가지 책임](#12-하네스를-쓰는-팀원의-5가지-책임)
...
8. 하네스는 나중에 크게 터질 문제를 앞에서 작게 잡아준다.
```
