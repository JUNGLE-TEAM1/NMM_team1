...
| M5 direct spark_runner 제거 Hotfix | [`m5-direct-spark-runner-removal.md`](m5-direct-spark-runner-removal.md) | M5 workflow API에서 direct `spark_runner` executor를 제거하고 Airflow/Spark 역할 혼동을 막은 기준 확인 |
