...
| Frontend SourcesPage decomposition | [`frontend-sources-page-decomposition.md`](frontend-sources-page-decomposition.md) | `SourcesPage` dataset workspace를 feature boundary로 분리하고 `App.jsx`를 route shell 중심으로 축소했는지 확인 |
