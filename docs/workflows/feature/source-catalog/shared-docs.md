...
| `docs/02-architecture.md` | backend/frontend layer layout, dependency direction, M4 ports added | M4 before pipeline work needs replaceable module boundaries. | 중간: future code should follow the dependency direction |
