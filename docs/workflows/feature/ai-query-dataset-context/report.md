...
- Remaining: PR #314 review/merge/finalize with linked issue #316. CI passed; full backend suite has an environment-only gap: `144 passed`, 2 Taxi Spark tests failed because this local machine has no Java Runtime.
