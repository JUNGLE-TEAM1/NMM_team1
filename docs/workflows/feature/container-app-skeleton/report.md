...
- Changed: FastAPI backend skeleton, React/Vite frontend shell, source-based Dockerfile, `docker-compose.yml`, container smoke script, CI container smoke, README/development guide/interface docs, M2 port policy, M2 workspace 기록
