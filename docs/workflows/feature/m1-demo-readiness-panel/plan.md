...
- [ ] readiness panel이 M2/M3/M5/M6/M1 상태를 표시한다.
- [ ] 확인 불가능한 상태는 `unknown` 또는 `not-ready`로 표시한다.
- [ ] Gold output/Catalog/query evidence 미준비가 fake success로 보이지 않는다.
- [ ] 기존 `/etl`, `/catalog`, `/query` layout이 깨지지 않는다.
- [ ] `cd frontend && npm run build` 통과
- [ ] readiness panel keyword scan 통과
