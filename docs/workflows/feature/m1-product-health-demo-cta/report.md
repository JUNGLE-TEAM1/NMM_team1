...
- Verified: `cd frontend && npm run build`, CTA keyword scan, `git diff --check`, docker browser smoke(`/query?smoke=product-health-cta`), `scripts/validate-harness.sh --strict` 통과.
