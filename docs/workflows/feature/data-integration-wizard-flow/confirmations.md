# Data integration wizard flow 사람 확인 게이트
...
- Human response: 사용자가 wizard flow 진행과 AWS/XFlow식 UI 개선을 지시함.
...
- Human response: backend/API/schema/payload 변경 없이 UI layout만 보완.
