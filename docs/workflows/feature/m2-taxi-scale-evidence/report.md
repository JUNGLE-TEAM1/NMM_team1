...
- Verified: PySpark local install smoke succeeded with Spark `4.1.2`; focused Taxi Spark/storage tests passed; M5 boundary-focused suite passed; local January 2024 Spark demo smoke succeeded; temporary MinIO smoke succeeded with `spark_upload_taxi_daily_metrics`.
