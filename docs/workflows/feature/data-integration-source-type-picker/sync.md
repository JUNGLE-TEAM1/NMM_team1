# Data integration source type picker Git Sync
...
- main branch: main
- current branch: feature/data-integration-source-type-picker
- base commit: 6775c406
- pulled at:
- command:
- result: Workspace created from feature/data-integration-source-step at 6775c406; `git switch -c feature/data-integration-source-type-picker`로 보정 branch 생성. 자동 pull/merge/rebase는 실행하지 않음.
