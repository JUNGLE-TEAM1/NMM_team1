# Data integration source type picker 사람 확인 게이트
...
- Human response: 사용자가 "보정 페이즈를 진행해줘"라고 지시함.
...
- Human response: backend/API/schema/connector 계약 변경 없이 demo UI fixture로 진행.
