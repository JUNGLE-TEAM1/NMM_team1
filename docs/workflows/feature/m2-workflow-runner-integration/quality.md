...
| unit/focused test | `PYTHONPATH=backend .venv/bin/pytest backend/tests/test_week2_workflow_catalog.py backend/tests/test_week2_spark_runner.py -q` | passed | 17 passed |
| integration/contract test | `PYTHONPATH=backend .venv/bin/pytest backend/tests -q` | passed | 50 passed |
