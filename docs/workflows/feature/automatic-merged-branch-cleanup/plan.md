# Automatic merged branch cleanup 계획

## 브랜치

- Branch: `feature/automatic-merged-branch-cleanup`
- Workspace: `docs/workflows/feature/automatic-merged-branch-cleanup`
- Created: 2026-06-22

## 목표

- `PR 진행` 흐름에 PR merge/finalize 후 자동 merged branch cleanup을 포함한다.
