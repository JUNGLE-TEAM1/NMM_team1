# Human-facing big dataset clarity 품질 게이트
...
- Pass command/result: documentation search와 harness validation 예정
- Refactor notes: 제품 방향 문구를 대용량/복합 데이터셋 조작·검산 중심으로 더 선명하게 정렬했다.

## Branch Checks / 브랜치 검증

| Check | Command | Result | Evidence |
| --- | --- | --- | --- |
| human-facing docs search | `rg -n "대용량/복합 데이터셋|신뢰 가능한 분석 자산|row count/bytes/duration/output path|수집·스키마화·변환·검산·게시|대표 데이터셋" README.md docs/reports/project-onboarding-summary.md docs/project-context/README.md docs/project-context/asklake-week2-module-plan/README.md docs/reports/README.md` | pass | 사람이 보는 문서에서 big dataset context 확인 |
