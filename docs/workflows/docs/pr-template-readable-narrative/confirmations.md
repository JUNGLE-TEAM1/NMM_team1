...
- Human response: "오케이 이걸로 템플릿 보강하자"
...
- Human response: 제품/API/schema/data contract 변경 없음
...
- Ask human to confirm:
  ...
  - completion criteria
- Human response: 하네스 테스트와 dry-run으로 검증 진행
...
- Human response: 하네스 behavior 변경이므로 fixture/static validation 적용
...
- Human response: branch base를 origin/main `8ab9a76`으로 바로잡고 sync.md에 기록
...
- Ask human to confirm:
  ...
  - 남은 위험
  - 다음 작업 문맥
- Human response: 검증 완료 후 PR 생성 대상
