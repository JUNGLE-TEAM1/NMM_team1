...
| --- | --- | --- | --- |
| `docs/project-context/asklake-week2-module-plan/ver2/README.md` | 세 데이터 경로와 분석 대표 경로 기준 추가 | 팀원이 `ver2/` 첫 문서에서 Taxi/Kafka를 optional로 오해하지 않도록 | low |
...
| `docs/project-context/asklake-week2-module-plan/ver2/main-e2e-path.md` | main path를 분석 대표 경로로 명확화 | Amazon Reviews만 사용한다는 오해를 줄이고 Taxi/Kafka 필수 evidence를 보존 | low |
...
| `docs/project-context/asklake-week2-module-plan/ver2/original-vs-revised-flow.md` | 발표 일정 반영 결정 문구 보강 | 원래 분업 대비 ver2 역할 변화가 optional 축소로 읽히지 않도록 | low |
