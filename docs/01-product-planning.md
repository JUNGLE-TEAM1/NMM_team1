...
| R7. Packaging 안정화 | Packaging | self-hosted 배포 프로파일을 정리한다 | Helm/dev-lite 후보, health check, secret/config 검증 | cloud resource 자동 생성 | local/container smoke와 manifest 검증 통과 |
