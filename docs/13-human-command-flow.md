...
- If GitHub record drift audit finds an English-only/conventional PR title, missing readable PR handoff body, or a real linked issue without closing keyword, AI stops PR progression until the record is corrected or the human explicitly confirms the exception.
